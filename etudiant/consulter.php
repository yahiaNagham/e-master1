...
<html>
    ...
    <table>
        ...
        <tbody>
            <tr>
                <td>Projet 1</td>
                <td> Domaine de l'informatique qui <br> vise à développer des systèmes 
                  capables de simuler <br> des comportements humains, 
                  tels que la prise de décision,<br> l'apprentissage automatique et le traitement des données.</td>
            ...
            <tr>
                <td>Projet 2</td>
                <td> Création et maintenance <br>
             de sites et applications web,<br>
              englobant la conception <br>(interface utilisateur) <br>et le développement back-end (serveurs, bases de données).</td>
                <td>Développement web</td>
                <td>HTML, CSS, JavaScript</td>
                <td>Fermé</td>
                <td><a href="#" class="btn" id="details">Détails</a></td>
            </tr>
            <tr>
              <td>Projet 3</td>
          ...
          <tr>
            <td>Projet 4</td>
            <td>application mobile de suivi de la santé<br>avec des consultations à distance.</td>
