							...
							<!-- Banner -->
								<section id="banner">
									<div class="content">
										...
										<h3>عزيزي طالب , تهانينا الحارة و مرحبا بك في الاسرة الجامعية</h3>
                    <h3 class="text-h">Cher etudiant,toutes nos Felicitations et Bienvenue dans la communaute universitaire</h3>
                    <h3 class="text-h">Dear student,Congratulation and Welcome to the University community</h3>
									</div>
